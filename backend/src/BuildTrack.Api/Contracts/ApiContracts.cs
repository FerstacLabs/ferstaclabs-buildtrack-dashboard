...
public sealed record AttendanceDailyRosterResponse(
    DateOnly WorkDate,
    string PlannedStart,
    string PlannedEnd,
    ...
    IReadOnlyList<AttendanceDailyRosterRowResponse> Rows);

public sealed record AttendanceDailyRosterRowResponse(
    string Key,
    Guid WorkerId,
    string WorkerExternalId,
    string WorkerName,
...
public sealed record AttendanceDisciplineResponse(
    DateOnly DateFrom,
    DateOnly DateTo,
    string PlannedStart,
    string PlannedEnd,
    ...
    IReadOnlyList<AttendanceDisciplineRowResponse> Rows,
    IReadOnlyList<AttendanceDisciplineTrendPointResponse> Trend);

public sealed record AttendanceDisciplineRowResponse(
    string Key,
    Guid WorkerId,
    string WorkerExternalId,
    string WorkerName,
...
public sealed record AttendanceDisciplineTrendPointResponse(
    string Key,
    DateOnly Date,
    string Label,
    int LateCount,
